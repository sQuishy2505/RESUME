...
export default function Home() {
  ...
  <>
   ...
   <p className="text-[50px] font-bold ml-[100px]">HI, I AM</p>
    <img src="https://i.pinimg.com/736x/7d/f0/24/7df0249cd3d8564afb5c3c52120d321f.jpg" width={350} height={300} alt="Profile Picture" className=" mr-[100px] border-solid b- shadow-lg shadow-[#ffffff]" />
      ...
      {[...Array(20)].map((_, i) => (
        <div
          ...
          style={{
            ...
            position: 'absolute', // ตัวอย่างการกำหนดค่าอื่นๆ
            top: '10px',
          }}
        ></div>
      ))}
